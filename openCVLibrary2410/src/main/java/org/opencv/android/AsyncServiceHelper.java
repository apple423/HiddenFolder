...
class AsyncServiceHelper
{
            ...
            final LoaderCallbackInterface Callback)
    {
        ...
        Intent i = new Intent("org.opencv.engine.BIND");
        i.setPackage("org.opencv.engine");
        if (AppContext.bindService(i, helper.mServiceConnection, Context.BIND_AUTO_CREATE))
        {
            return true;
        }
        else
