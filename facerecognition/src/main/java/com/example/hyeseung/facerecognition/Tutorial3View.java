...
import com.example.hyeseung.filemanager.Constants;
    ...
    public void takePicture(final String fileName) {
        ...
        PictureCallback callback = new PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                try {
                    File appDir = new File(Constants.appPath+"/침입자");
                    if (!appDir.exists())
                        appDir.mkdirs();
                    FileOutputStream out = new FileOutputStream(Constants.appPath+"/침입자/"+mPictureFileName+".jpg");
